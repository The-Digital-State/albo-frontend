export default {
  ...
  messages: {
    ...
    date: 'Поле {_fields_} имеет недопустимый формат даты',
    dateMax: 'Поле {_field_} не может быть больше {max}',
    dateMin: 'Поле {_field_} не может быть меньше {min}',
    emails: 'Поле {_field_} содержит значение которое должно быть действительным электронным адресом',
  },
};
